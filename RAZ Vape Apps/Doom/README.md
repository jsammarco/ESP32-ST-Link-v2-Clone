...
- One short button tap: turn right immediately on release.
- Two short button taps within about 0.45 seconds: turn left (the second press reverses the first turn).
- Hold the button for about 0.2 seconds: walk forward; keep holding to continue walking.
